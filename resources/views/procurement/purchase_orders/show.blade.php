        ...
        <div class="col-md-9">
            <div class="card shadow-sm">
                <div class="card-header bg-dark d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        @if (in_array($purchaseOrder->status, ['Approved', 'Open']))
                        ...
                        @endif
                        <span
                            class="badge badge-{{ $purchaseOrder->status == 'Approved' ? 'info' : ($purchaseOrder->status == 'Open' ? 'success' : 'secondary') }} px-3 py-2">
                ...
                <div class="card-footer bg-white text-right">
                    ...
                    @if ($purchaseOrder->status == 'Draft')
                        <button class="btn btn-success btn-sm"><i class="fas fa-check-circle mr-1"></i> Approve PO</button>
                    @endif
                </div>
            </div>
        </div>
